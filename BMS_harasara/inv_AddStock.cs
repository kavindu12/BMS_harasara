            ...
            MySqlDataReader reader;
                ...
                while (reader.Read())
                {
                    ...
                    float pricef = (pricet + price)/2;
                        ...
                        try
                                    {
                                        String qry2 = "Insert into inv_trans(item_id,count,price,location,type) values('" + itemId + "','" + count + "','" + price + "','" + loc + "','" + ttype + "')";
                                        String qry1 = "Update inventory set count='"+countf+"',price='"+pricef+"' where (item_id='"+itemId+"'or name='"+name+"')and location='"+loc+"'";
